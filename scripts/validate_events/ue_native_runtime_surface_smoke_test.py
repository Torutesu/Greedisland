...
def main() -> int:
    ...
    runtime_cpp = (ROOT / "UnrealProject/Source/Greeisland/Runtime/GreeislandGameSubsystem.cpp").read_text(encoding="utf-8")
    ...
    assert_true("has already been completed" in session_library, "session blocks completed battle replay")
    assert_true("&& !ViewData.bCompleted" in runtime_cpp, "runtime hides completed events from available interactions")

...
def main() -> int:
    ...
    assert_true("required cards missing" in cpp_text, "event view explains missing card requirements")
    assert_true("bRequirementsMet" in cpp_text, "event view checks required cards before interaction")
